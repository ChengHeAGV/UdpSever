        ...
        private void func()
        {
            while (true)
            {
                ...
                this.Invoke(new MethodInvoker(delegate
                {
                    var num = 0;
                    var reg = 51;
                    dataGridView1.Rows[num].Cells[0].Value = UdpSever.Register[deviceNum, reg, 1].ToString("yyyy - MM - dd");
                    dataGridView1.Rows[num].Cells[1].Value = UdpSever.Register[deviceNum, reg, 1].ToString("HH: mm:ss");
